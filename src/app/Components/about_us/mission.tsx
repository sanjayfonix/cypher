...
export default function MissionSection() {
  ...
  return (
    ...
    >
      ...
      {/* LEFT SIDE: RADAR */}
      <div className="sticky left-0 sm:left-[0%] lg:left-0 lg:top-24 self-start w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] md:w-[350px] md:h-[350px] lg:w-[450px] lg:h-[450px] flex items-center justify-center mx-auto md:mx-0">
