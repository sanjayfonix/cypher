...
interface AltGridProps {
  ...
  vertical?: {
    ...
    // NEW optional coordinates (overrides above if present)
    from?: { x: number; y: number };
    to?: { x: number; y: number };
  }[];
}

export const AltGrid: React.FC<AltGridProps> = ({
  width = "100%", // default responsive
  height = "100%",
  pointerWidth = 25,
  pointerHeight = 6,
  speed = 4,
  isAlternativeGrid = false,
  horizontal = {
    y: 184.982,
    fromX: 196.18,
    toX: 80.7358,
  ...
  return (
    <svg
      width={width}
      height={height}
      viewBox={isAlternativeGrid ? "0 0 311 297" : "0 0 200 260"}
    ...
    >
      ...
      {!isAlternativeGrid ? (
        ...
        <path
          d="M231.929 68.4336H171.929V0.493164H170.929V68.4336H110.929V0.493164H109.929V68.4336H50.9287V0.493164H49.9287V68.4336H-4V69.4336H49.9287V128.434H-4V129.434H49.9287V188.434H-5V189.434H49.9287V248.434H-5V249.434H49.9287V297.493H50.9287V249.434H109.929V297.493H110.929V249.434H170.929V297.493H171.929V249.434H231.929V297.493H232.929V249.434H310V248.434H232.929V189.434H310V188.434H232.929V129.434H311V128.434H232.929V69.4336H311V68.4336H232.929V0.493164H231.929V68.4336ZM231.929 248.434H171.929V189.434H231.929V248.434ZM170.929 248.434H110.929V189.434H170.929V248.434ZM109.929 248.434H50.9287V189.434H109.929V248.434ZM231.929 188.434H171.929V129.434H231.929V188.434ZM170.929 188.434H110.929V129.434H170.929V188.434ZM109.929 188.434H50.9287V129.434H109.929V188.434ZM231.929 69.4336V128.434H171.929V69.4336H231.929ZM170.929 69.4336V128.434H110.929V69.4336H170.929ZM109.929 69.4336V128.434H50.9287V69.4336H109.929Z"
          fill="url(#paint0_linear_alt)"
        />
      )}
      ...
      <defs>
        {!isAlternativeGrid ? (
          ...
          >
            <stop stopColor="white" stopOpacity="0.1" />
            <stop offset="0.822115" stopColor="#999999" stopOpacity="0" />
          </linearGradient>
        )}
          ...
          <g
            transform={
              horizontal.direction === "left"
                ...
                : "scale(1,-1) translate(27,43) rotate(-180)"
            }
          >
      ...
      {/* 🔹 Vertical/custom pointers */}
      {vertical.map((v, idx) => {
        // if custom coordinates provided
        if (v.from && v.to) {
          return (
            <g key={idx}>
              <path
                id={`custom-line-${idx}`}
                d={`M${v.from.x} ${v.from.y} L${v.to.x} ${v.to.y}`}
                stroke="transparent"
                fill="none"
              />
              <svg
              ...
              <animateMotion
                ...
                orient="auto"
              >
                <mpath href={`#custom-line-${idx}`} />
              </animateMotion>
            </g>
          );
        }

        // fallback: normal vertical behavior
        return (
          <g
            key={idx}
            transform={
              v.direction === "up"
                ? "rotate(90) translate(-25,-3)"
                : "rotate(-90) translate(0,-3)"
            }
          >
            <path
              id={`v-line-${idx}`}
