    ...
    <div className="bg-black text-white px-7 py-4 flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row gap-6  w-full">
        ...
        <div className="flex flex-col justify-between flex-1 gap-6">
          {/* Consulting & Advisory */}
          <div className="relative bg-gradient-to-b from-[#030A1400] to-[#167BFFB2] border border-[#6D6D6D99] p-6 rounded-3xl shadow-lg flex flex-col justify-between">
          ...
          <div className="overflow-hidden relative bg-[linear-gradient(110.77deg,rgba(3,10,20,0)_0%,rgba(22,123,255,0.12)_91.47%)] border border-[#6D6D6D] rounded-3xl shadow-lg flex flex-col justify-between h-full">
            ...
            <div className="relative  flex items-end justify-center mx-auto w-[367px] h-[367px]">
              ...
              <div className="absolute top-[20%] left-[0px] w-[60px] h-[60px] flex flex-col justify-center items-center gap-1 p-2 rounded-[42px] opacity-100 bg-[linear-gradient(180deg,rgba(3,10,20,0.2)_28.22%,rgba(21,122,255,0.2)_185.84%)] shadow-[0_0_50px_0_#157AFF99]">
              <InstaIcon/>  
              </div>
              <div className="absolute top-[0%] left-[25%] w-[60px] h-[60px] flex flex-col gap-1 p-2 rounded-[42px] opacity-100 bg-[linear-gradient(180deg,rgba(3,10,20,0.2)_28.22%,rgba(21,122,255,0.2)_185.84%)] shadow-[0_0_50px_0_#157AFF99] justify-center items-center"><XIcon/></div>
              <div className="absolute top-[0%] left-[59%] w-[60px] h-[60px] flex flex-col gap-1 p-2 rounded-[42px] opacity-100 bg-[linear-gradient(180deg,rgba(3,10,20,0.2)_28.22%,rgba(21,122,255,0.2)_185.84%)] shadow-[0_0_50px_0_#157AFF99] justify-center items-center"><WhatsappIcon/></div>
              <div className="absolute top-[20%] left-[82%] w-[60px] h-[60px] flex flex-col gap-1 p-2 rounded-[42px] opacity-100 bg-[linear-gradient(180deg,rgba(3,10,20,0.2)_28.22%,rgba(21,122,255,0.2)_185.84%)] shadow-[0_0_50px_0_#157AFF99] justify-center items-center"><FbIcon/></div>

              {/* Vertical rectangle */}
              <div className="relative overflow-y-hidden overflow-x-visible w-[153px] h-[75%] flex flex-col gap-1 p-2 rounded-[5px] opacity-100 bg-[linear-gradient(180deg,rgba(3,10,20,0.2)_28.22%,rgba(21,122,255,0.2)_185.84%)] shadow-[0_0_110px_0_#157AFF66]">
