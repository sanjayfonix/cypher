...
export const BlueInstaIcon = () => (
 <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.8333 1.625C20.1683 1.625 22.875 4.33167 22.875 7.66667V17.3333C22.875 20.6683 20.1683 23.375 16.8333 23.375H7.16667C3.83167 23.375 1.125 20.6683 1.125 17.3333V7.66667C1.125 4.33167 3.83167 1.625 7.16667 1.625H12H16.8333Z" stroke="#167bff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M12 7.66675C14.6704 7.66675 16.8333 9.82966 16.8333 12.5001C16.8333 15.1705 14.6704 17.3334 12 17.3334C9.32957 17.3334 7.16666 15.1705 7.16666 12.5001C7.16666 9.82966 9.32957 7.66675 12 7.66675Z" stroke="#167bff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
